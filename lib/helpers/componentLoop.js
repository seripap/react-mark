...
var componentLoop = exports.componentLoop = function componentLoop(elements, replace, transform) {
  var children = [];
  var name = void 0;
  var args = {};
  ...
  return (0, _findComponent2.default)(name, args, children, replace, transform);
};
